...
class Application:
    def __init__(self, master=None):
        self.fonte = ("Verdana", "8")   #fonte geral do app
     
        self.container1 = Frame(master) #inicia o container
        self.container1["pady"] = 10    #padding vertical do app
        self.container1.pack()          #"cria" o container
        ...
        self.titulo = Label(self.container1, text="Informe os dados :") #inicia uma label para o container em questao
        self.titulo["font"] = ("Calibri", "9", "bold") #fonte personalizada
        self.titulo.pack () #"cria" o objeto em questao
    ...
    def inserirUsuario(self):
        user = Usuarios() #inicia a variavel utilizando a classe usuarios

        #recebe os valores informados na aplicacao
        ...
        #limpa os valores apos utilizados
    ...
    def buscarUsuario(self):
        ...
        self.txtidusuario.delete(0, END) #limpa os valores apos utilizados
        self.txtidusuario.insert(INSERT, user.idusuario) #insere os valores que seriam utilizados
